...
class BuoyDetector(Node):
    ...
    def __init__(self):
        ...
        # Body-frame detections move when the USV translates or
        # yaws. Increase the association radius slightly with
        # target range to tolerate this motion.
        self.association_distance_per_meter = float(
            self.declare_parameter(
                'association_distance_per_meter', 0.05
            ).value
        )
